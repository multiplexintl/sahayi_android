...
class InvoiveTransferSceen extends StatelessWidget {
  const InvoiveTransferSceen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomWidget.customAppBar(
        con.isInvoice.value ? "Invoice" : "Transfer",
        connectivity: false,
        logout: null,
        back: true,
      ),
          ...
          children: [
            ...
            Align(
              ...
              child: Padding(
                ...
                child: Obx(() => Text(
                      "Last fetched 10 ${con.isInvoice.value ? "invoices" : "transfers"}",
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    alignment: Alignment.center,
                    child: Text(
                      "${con.isInvoice.value ? "Invoice" : "Transfer"} Number",
                      style: Theme.of(context).textTheme.labelLarge,
                    ),
                  ),
                  Container(
