...
import '../../model/pickers/pickers.dart';
        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Obx(
                  () => CustomDropdown<Pickers?>(
                    items: con.pickerList,
                    onChanged: con.syncIsLoading.value
                        ? null
                        : (value) {
                            con.selectPicker(value!);
                          },
                    selectedItem: con.selectedPicker.value,
                    height: 53,
                    width: context.width,
                    isDisabled: con.syncIsLoading.value,
                    getItemLabel: (picker) => picker?.name ?? '',
                    label: "Select Picker",
                  ),
                ),
              ),
              ...
              //   height: 60,
              //   width: context.width - 100,
              //   child: DropDownSearchField<Pickers>(
              ...
              //       return con.searchPickers(pattern);
              //     },
              ...
              //       con.selectPicker(suggestion);
              //     },
              //   ),
              // ),
              // FormField<Pickers>(
              //   validator: (value) =>
              //       value == null ? "Please select a valid option" : null,
              //   builder: (FormFieldState<Pickers> state) {
              //     var isDisabled = con.syncIsLoading.value;
              //     return Column(
              ...
              //             children: [
              //               Expanded(
              //                 child: Autocomplete<Pickers>(
              //                   optionsViewOpenDirection:
              //                       OptionsViewOpenDirection.up,
              //                   optionsBuilder:
              //                       (TextEditingValue textEditingValue) {
              //                     if (textEditingValue.text.isEmpty) {
              //                       return con.pickerList;
              //                     }
              //                     return con.pickerList.where((Pickers picker) {
              //                       return picker.name!.toLowerCase().contains(
              //                           textEditingValue.text.toLowerCase());
              //                     }).toList();
              //                   },
              //                   displayStringForOption: (Pickers option) =>
              //                       option.name ?? '',
              //                   onSelected: (Pickers picker) {
              //                     con.selectPicker(picker);
              //                     state.didChange(picker);
              //                   },
              ...
              //                         if (value.isNotEmpty) {
              //                           con.addNewPicker(value);
              //                           textEditingController.text = value;
              //                         }
              //                       },
              //                       decoration: InputDecoration(
              //                         border: InputBorder.none,
              //                         hintText: "Select or Type a Picker",
...
// class CompanyDropdown<T> extends StatelessWidget {
